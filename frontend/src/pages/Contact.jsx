    ...
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-10 mb-28 text-sm'>
        ...
        <div className='flex flex-col justify-center items-start gap-6'>
          ...
          <br/> Email: MediCare@gmail.com</p>
          <p className='font-semibold text-lg text-gray-600'>Careers at MediCare</p>
          <p className='text-gray-500'>Learn more about our teams and job openings.</p>
          <button className='border border-black py-4 px-8 text-sm rounded-lg hover:bg-blue-600 hover:border-white hover:text-white '>Explore Jobs</button>
        </div>
      </div>
    </div>
  )
